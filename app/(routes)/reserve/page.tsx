        ...
        <div className="mx-auto max-w-7xl font-karla p-8 text-lg">
          <div>
            ...
            <p className="pb-4">
              ...
              list for kittens. Going on the waiting list doesn&apos;t guarantee
              you a kitten but there are no obligations and no deposit required
              to be on the waiting list. We contact people on our waiting list
              via email on the day we know that our queen is pregnant. You are
              very welcome to contact us any way you prefer and we will add your
              name and your contact information to our waiting list. Once the
              kittens are born it will be available to reserve one or more
          ...
          <div>
            ...
            <p className="pb-4">
              ...
              deposit shouldn&apos;t be an issue. The balance is to be paid in
              cash on the day of collection or by bank transfer seven days
              prior, so that the bank transfer clears into our bank account. We
              reserve the right to refuse a sale & to withdraw a kitten from
              being for sale. If the kitten that is withdrawn from sale has been
              reserved, an alternative kitten will be offered. If we&apos;re
              unable to provide you with the same colour & sex kitten you
